...
If you have access to a 3D printer, Print the stl files in stl-figurines and stl-tokens folders. For the tokens, you'll have to print a lot! Choose colors that make sense to you for example: red for life tokens, gold for gold coins, purple or green for monster tokens etc.. You'll need 75 or more of the life tokens and gold coins, 2 sets of the 26 monster tokens (two of each letter) 25 time tokens, and 6 death tokens. Monster tokens have raised letters on them. you might want to color the tops of these with a sharpie or contrasting paint for extra visibility. 

Read through Rules_Magic and Mayhem.pdf LMK if you have questions or things are unclear - I'll revise and repost!

# A few other things you'll need: 
* 1 6-sided die
* 1 hourglass sand timer (or use your phone as a timer). 

# Modifying
See Extending-Magic-and-Mayhem.md
Please feel free to modify or add your own cards to the mix! Give me a shout out! Or send a Pull Request to propose changes to this project. (loose) standards for pull requested content are outlined in the extension guide.

# Acknowledgements
Almost all the figurine STLs for 3D printing are generated by meshy.ai, The gold coins are downloaded from thingiverse; The tokens are based on a set made for Magic the Gathering by tonyyoungblood, heavily modified to be stackable (by me!).
