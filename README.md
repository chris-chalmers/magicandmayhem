...
# Setup
Print Magic-and-mayhem-cards.pdf, double-sided, preferably on card stock. Cut each page into 4 1/4 sheet cards. 3D Print files in stl-figurines and str-tokens folders. choose colors that make sense to you for example: red for life tokens, black for death tokens, purple for monsters etc..

Read through Rules_ Magic and Mayhem.pdf LMK if you have questions or things are unclear - I'll revise and repost!

*A few other things you'll need:* 1 6 sided die, 1 hourglass or other timer. 

# Acknowledgements
Almost all the figurine STLs for 3D printing are downloaded from thingiverse, The tokens are based on a set made for Magic the Gathering by tonyyoungblood.
